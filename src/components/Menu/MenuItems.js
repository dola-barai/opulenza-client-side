...
const MenuItems = () => {
    ...
    return (
        <div>
            ...
            <div className='bg-opacity-50 py-5 bg-hero bg-cover bg-right pt-28' >
                <div>
                ...
                <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
                    <TabList className="md:flex justify-center rounded-lg gap-10 bg-black bg-opacity-70 my-1 px-2 mx-10 py-1 h-[60px]" >
                        <Tab activeClass="active" className="text-[#F1ECE1] hover:text-gray-500 tab font-primary w-full py-2 text-semibold rounded-none text-xl text-center"><button>Indian Cuisine</button></Tab>
                        <Tab className="text-[#F1ECE1] hover:text-gray-500 tab w-full py-2 font-primary text-semibold rounded-none text-xl text-center"><button>North Indian Cuisine</button></Tab>
                        <Tab className="text-[#F1ECE1] hover:text-gray-500 tab w-full py-2 font-primary text-semibold rounded-none text-xl text-center"><button>South Indian Cuisine</button></Tab>
                        <Tab className="text-[#F1ECE1] hover:text-gray-500 tab w-full py-2 font-primary text-semibold rounded-none text-xl text-center"><button>Italian Cuisine</button></Tab>
                    </TabList>
                    <TabPanel>
